...
// 					state_machine.Transition("chemical_spill.silver_align.backward")
// 				}
// 			},
// 		})

// 		state_machine.Add(state_machine.State{
// 			Name: "chemical_spill.silver_align.backward",
// 			Enter: func() {
...
// 					} else {
// 						state_machine.Transition("chemical_spill.silver_align.forward")
// 					}
// 				}
// 			},
// 		})
...
// 		state_machine.Add(state_machine.State{
// 			Name: "chemical_spill.silver_align.forward",
// 			Enter: func() {
// 				bot.DriveMotorLeft.Run(CHEMICAL_SPILL_VERIFY_SPEED)
// 				bot.DriveMotorRight.Run(CHEMICAL_SPILL_VERIFY_SPEED)
// 			},
...
// 			Update: func() {
// 				if helper.IsDriveStopped() {
// 					state_machine.Transition("chemical_spill.search.rotate_to_first_diagonal")
// 				}
// 			},
// 			Exit: func() {
// 				helper.OpenClaw()
...
// 		// state_machine.Add(state_machine.State{
// 		// 	Name: "chemical_spill.search.rotate_to_first_diagonal",
// 		// 	Enter: func() {
// 		// 		bot.DriveMotorLeft.ResetPosition()
// 		// 		bot.DriveMotorLeft.RunToAbsolutePositionAndHold(-CHEMICAL_SPILL_SEARCH_FIRST_DIAGONAL_POSITION, CHEMICAL_SPILL_SEARCH_SPEED)
// 		// 		bot.DriveMotorRight.RunToAbsolutePositionAndHold(CHEMICAL_SPILL_SEARCH_FIRST_DIAGONAL_POSITION, CHEMICAL_SPILL_SEARCH_SPEED)
// 		// 	},
// 		// 	Update: func() {
// 		// 		if helper.IsDriveStopped() {
// 		// 			state_machine.Transition("chemical_spill.search.check_diagonal")
// 		// 		}
// 		// 	},
// 		// })

// 		// state_machine.Add(state_machine.State{
// 		// 	Name: "chemical_spill.search.search.check_diagonal",
// 		// 	Enter: func() {
// 		// 		bot.DriveMotorLeft.RunToAbsolutePositionAndHold(CHEMICAL_SPILL_SEARCH_DIAGONAL_CHECK_POSITION, CHEMICAL_SPILL_SEARCH_SPEED)
// 		// 		bot.DriveMotorRight.RunToAbsolutePositionAndHold(CHEMICAL_SPILL_SEARCH_DIAGONAL_CHECK_POSITION, CHEMICAL_SPILL_SEARCH_SPEED)
// 		// 	},
// 		// 	Update: func() {
// 		// 		if helper.IsDriveStopped() {
// 		// 			state_machine.Transition("chemical_spill.check_diagonal")
// 		// 		}
// 		// 	},
// 		// })

// 		state_machine.Add(state_machine.State{
// 			Name: "chemical_spill.search",
// 			Enter: func() {
// 				helper.OpenClaw()
...
// 			Enter: func() {
// 				rotation := int(float64(bot.DriveMotorRight.Position()) * (2.0 / 3.0))
// 				bot.DriveMotorLeft.RunToAbsolutePositionAndHold(rotation, CHEMICAL_SPILL_SEARCH_SPEED)
// 				bot.DriveMotorRight.RunToAbsolutePositionAndHold(rotation, -CHEMICAL_SPILL_SEARCH_SPEED)
// 			},
// 			Update: func() {
