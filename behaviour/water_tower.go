...
func WaterTowerVerify() {
	bot.DriveMotorLeft.RunToRelativePositionAndHold(-WATER_TOWER_VERIFY_POSITION_LIMIT, WATER_TOWER_SPEED / 2)
	bot.DriveMotorRight.RunToRelativePositionAndHold(-WATER_TOWER_VERIFY_POSITION_LIMIT, WATER_TOWER_SPEED / 2)
